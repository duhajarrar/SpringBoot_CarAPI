...
public class CarController {
    ...
    public Page<Car> findByCountryOfOrigin(@PathVariable("countryOfOrigin") String countryOfOrigin, Pageable pageRequest) {
        System.out.println("Connnnnnnnnnntroller carrrrr *************"+countryOfOrigin);
        return carService.getCarByCountryOfOrigin(countryOfOrigin,pageRequest);
    }
}